...
<div className="flex flex-wrap sm:flex-row max-sm:grid max-sm:grid-cols-2 justify-center gap-2 sm:gap-3 px-4 sm:px-0">
  {technologies.map((tech, index) => (
    <span
      key={index}
      className="px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 text-slate-700 rounded-full font-medium text-sm sm:text-base hover:from-blue-200 hover:to-purple-200 transition-all duration-200 hover:scale-105 cursor-default text-center"
    >
      {tech}
    </span>
  ))}
