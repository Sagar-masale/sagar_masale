  ...
  <div className="flex flex-row sm:flex-row gap-3 sm:gap-4 justify-center sm:justify-center items-start sm:items-center mb-10 px-4">
    ...
    onClick={scrollToProject}
     className="min-w-[160px] sm:w-auto px-4 py-2 text-sm sm:text-base bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all duration-200 hover:scale-105 shadow-sm sm:shadow-lg hover:shadow-xl">
      View My Work
    </button>
      <a
        href="/SagarMasale.pdf"
        download
        className="min-w-[160px] sm:w-auto px-4 py-2 text-sm sm:text-base border border-slate-300 text-slate-700 rounded-lg font-medium hover:border-blue-600 hover:text-blue-600 transition-all duration-200 text-center"
      >
        Download CV
      </a>
